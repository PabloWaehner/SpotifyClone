            ...
            <div id="inputContainer">
                <form id="loginForm" action="register.php" method="POST">
                    ...
                    <p>
                        ...
                        <input id="loginUsername" name="loginUsername" type="text" placeholder="name"
                ...
                <form id="registerForm" action="register.php" method="POST">
                    ...
                    <p>
                        ...
                        <input id="email" name="email" type="email" placeholder="e.g. email@gmail.com"
                            value="<?php getInputValue('email') ?>" required>
                    </p>
                    <p>
                        <label for="email2">Confirm email</label>
                        <input id="email2" name="email2" type="email" placeholder="e.g. email@gmail.com"
